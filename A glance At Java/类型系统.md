...
从 Java 语言也积极拥抱模式匹配特性，可以一窥，模式匹配的魅力。
...
#### 2. 面向对象中，函数的 Override

OvOverride函数时，我们能将父类函数函数
...
而 Java 支持 return type 是 covariance 的， 而Parameter Type 则是 invariance。  Override method, method2, method4 均会编译报错。
